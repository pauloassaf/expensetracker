...
function Form () {
    ...
    return (
        <FormStyled onSubmit={handleSubmit}>
            ...
            <div className="input-control">
                <input type="text" name={'amount'} placeholder='Salary Amount' onChange={handleInput('amount')} />    
            </div> 
            <div className="input-control">
            ...
            <div className='input-control'>
                <textarea name={'description'} placeholder='Add a description' id='description' cols='30' rows='4' onChange={handleInput('description')}></textarea>  
            </div>   
